...
public class CcLoggingVO{
    ...
    private CcLogging superior;

    public CcLogging getSuperior() {
        return superior;
    }

    public CcLoggingVO(CcLogging superior){
    ...
    public void setSuperior(CcLogging superior) {
        this.superior = superior;
    }
